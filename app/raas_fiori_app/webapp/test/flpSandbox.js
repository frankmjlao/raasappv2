		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CommunityBlogs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CommunityBlogs-display": {
								"semanticObject": "CommunityBlogs",
								"action": "display",
								"description": "Fiori blogs application",
								"title": "Community Blogs",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=raasfioriapp",
									"url": sap.ui.require.toUrl("raasfioriapp")
								}
							}
						}
					}
